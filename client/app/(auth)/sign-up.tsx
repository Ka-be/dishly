...
export default function SignUpScreen() {
  ...
  const handleGoogleSignUp = async () => {
    ...
    try {
      ...
      Alert.alert('Erreur', 'Impossible de créer un compte. Veuillez réessayer.');
    } finally {
      setIsLoading(false);
    }
  };
      ...
      <YStack gap="$8" alignItems="center" paddingHorizontal="$6" width="100%" maxWidth={480}>
        ...
        <YStack gap="$3" alignItems="center" width="100%">
          ...
          <Text
            ...
            lineHeight={24}
          >
            Rejoignez la communauté Dishly et commencez à créer, partager et découvrir des recettes
          </Text>
        </YStack>
        ...
        <YStack gap="$4" width="100%" marginTop="$4">
          ...
          >
            {isLoading ? (
              ...
              <XStack gap="$3" alignItems="center">
                <GoogleLogo />
                <Text fontSize={16} fontWeight="600" color={colors.tint}>
          ...
          <YStack gap="$3" marginTop="$2">
            <XStack gap="$2" alignItems="flex-start">
              <Text fontSize={16} color={colors.tint}>✓</Text>
              <Text fontSize={14} color={colors.icon} flex={1} lineHeight={20}>
                Créez et sauvegardez vos recettes préférées
              </Text>
            </XStack>
            <XStack gap="$2" alignItems="flex-start">
              <Text fontSize={16} color={colors.tint}>✓</Text>
              <Text fontSize={14} color={colors.icon} flex={1} lineHeight={20}>
                Suivez vos recettes pas à pas en mode cuisine
              </Text>
            </XStack>
            <XStack gap="$2" alignItems="flex-start">
              <Text fontSize={16} color={colors.tint}>✓</Text>
          ...
          {/* Divider */}
          <XStack gap="$3" alignItems="center" width="100%" marginVertical="$4">
